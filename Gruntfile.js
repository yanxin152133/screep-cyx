...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        screeps: {
            options: {
                email: email, password: password, branch: branch, ptr: ptr
            }, dist: {
                src: ['dist/*.js']
            }
        },
        ...
        rsync: {
            options: {
                args: ["--verbose", "--checksum"], exclude: [".git*"], recursive: true
            }, private: {
                options: {
                    src: './dist/', dest: private_directory,
                }
            },
        },
        ...
        jsbeautifier: {
            modify: {
                ...
                src: ["src/**/*.js"], options: {
                    mode: 'VERIFY_ONLY', config: '.jsbeautifyrc'
                }
            }
        }
